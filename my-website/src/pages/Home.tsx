...
export default function Home() {
  ...
  return (
    <div className={`absolute text-gray-200 inset-0 flex flex-col items-center justify-center min-h-screen h-full w-full overflow-y-auto py-2 overflow-hidden transition-all duration-[1500ms] ease-in ${isTransitioning ? 'translate-y-[-10vh] opacity-0' : 'translate-y-0 opacity-100'}`}>
      <h1 className="text-6xl font-bold drop-shadow-lg">Welcome to my portfolio</h1>
      <p className="text-lg md:text-xl text-center max-w-3xl px-4 md:px-8 drop-shadow-md leading-relaxed">
